                    ...
                    <div class="row small-gutters">
                        ...
                        <div class="col-lg-4 top-post-right">
                            ...
                            <div class="single-top-post mt-10">
                                <div class="feature-image-thumb relative">
                                    <div class="overlay overlay-bg"></div>
                                    <img class="img-fluid" src="storage/img/top-post3.jpg" alt="">
                                </div>
                                <div class="top-post-details">
                                    <ul class="tags">
                                        <li><a href="#">Food Habit</a></li>
                            ...
                            <div class="latest-post-wrap">
                                ...
                                <div class="single-latest-post row align-items-center">
                                    <div class="col-lg-5 post-left">
                                        <div class="feature-img relative">
                                            <div class="overlay overlay-bg"></div>
                                            <img class="img-fluid" src="storage/img/l2.jpg" alt="">
                                        </div>
                                        <ul class="tags">
                                ...
                                <div class="single-latest-post row align-items-center">
                                    <div class="col-lg-5 post-left">
                                        <div class="feature-img relative">
                                            <div class="overlay overlay-bg"></div>
                                            <img class="img-fluid" src="storage/img/l3.jpg" alt="">
                                        </div>
                                        <ul class="tags">
                                ...
                                <div class="single-latest-post row align-items-center">
                                    <div class="col-lg-5 post-left">
                                        <div class="feature-img relative">
                                            <div class="overlay overlay-bg"></div>
                                            <img class="img-fluid" src="storage/img/l4.jpg" alt="">
                                        </div>
                                        <ul class="tags">
                                ...
                                <div class="row mt-20 medium-gutters">
                                    <div class="col-lg-6 single-popular-post">
                                        <div class="feature-img-wrap relative">
                                            <div class="feature-img relative">
                                                <div class="overlay overlay-bg"></div>
                                                <img class="img-fluid" src="storage/img/f2.jpg" alt="">
                                            </div>
                                            <ul class="tags">
                                                <li><a href="#">Travel</a></li>
                                            </ul>
                                    ...
                                    <div class="col-lg-6 single-popular-post">
                                        <div class="feature-img-wrap relative">
                                            <div class="feature-img relative">
                                                <div class="overlay overlay-bg"></div>
                                                <img class="img-fluid" src="storage/img/f3.jpg" alt="">
                                            </div>
                                            <ul class="tags">
                                                <li><a href="#">Travel</a></li>
                                            </ul>
                                ...
                                <div class="relavent-story-list-wrap">
                                    <div class="single-relavent-post row align-items-center">
                                        <div class="col-lg-5 post-left">
                                            <div class="feature-img relative">
                                                <div class="overlay overlay-bg"></div>
                                                <img class="img-fluid" src="storage/img/r1.jpg" alt="">
                                            </div>
                                            <ul class="tags">
                                                <li><a href="#">Lifestyle</a></li>
                                            </ul>
                                    ...
                                    <div class="single-relavent-post row align-items-center">
                                        <div class="col-lg-5 post-left">
                                            <div class="feature-img relative">
                                                <div class="overlay overlay-bg"></div>
                                                <img class="img-fluid" src="storage/img/r2.jpg" alt="">
                                            </div>
                                            <ul class="tags">
                                                <li><a href="#">Science</a></li>
                                            </ul>
                                    ...
                                    <div class="single-relavent-post row align-items-center">
                                        <div class="col-lg-5 post-left">
                                            <div class="feature-img relative">
                                                <div class="overlay overlay-bg"></div>
                                                <img class="img-fluid" src="storage/img/r3.jpg" alt="">
                                            </div>
                                            <ul class="tags">
                                                <li><a href="#">Travel</a></li>
                                            </ul>
                                ...
                                <div class="single-sidebar-widget editors-pick-widget">
                                    ...
                                    <div class="editors-pick-post">
                                        <div class="feature-img-wrap relative">
                                            <div class="feature-img relative">
                                                <div class="overlay overlay-bg"></div>
                                                <img class="img-fluid" src="storage/img/e1.jpg" alt="">
                                            </div>
                                            <ul class="tags">
                                                <li><a href="#">Travel</a></li>
                                            </ul>
                                        ...
                                        <div class="post-lists">
                                            <div class="single-post d-flex flex-row">
                                                <div class="thumb">
                                                    <img src="storage/img/e2.jpg" alt="">
                                                </div>
                                                <div class="detail">
                                            ...
                                            <div class="single-post d-flex flex-row">
                                                <div class="thumb">
                                                    <img src="storage/img/e3.jpg" alt="">
                                                </div>
                                                <div class="detail">
                                            ...
                                            <div class="single-post d-flex flex-row">
                                                <div class="thumb">
                                                    <img src="storage/img/e4.jpg" alt="">
                                                </div>
                                                <div class="detail">
