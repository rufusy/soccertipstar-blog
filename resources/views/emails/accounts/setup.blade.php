...
<head>
    ...
    <title>Welcome to soccertipstar.com</title>
    <!-- https://my.stripo.email/cabinet/#/template-editor/?projectId=92490&templateId=114717&type=MY_TEMPLATE-->
    <!--[if (mso 16)]>
    <style type="text/css">
            ...
            <tr style="border-collapse:collapse;">
                <td valign="top" style="padding:0;Margin:0;">
                    <table class="es-header" cellspacing="0" cellpadding="0" align="center"
                        ...
                        <tr style="border-collapse:collapse;">
                            <td align="center" bgcolor="#222" style="padding:0;Margin:0;background-color:#222222;">
                    ...
                    <table class="es-content" cellspacing="0" cellpadding="0" align="center"
                        ...
                        <tr style="border-collapse:collapse;">
                            <td style="padding:0;Margin:0;background-color:#222222;" bgcolor="#222" align="center">
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td class="es-m-txt-l" bgcolor="#ffffff" align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        you need to&nbsp; sign in your account, change your password and
                                                                        complete your profile. Just press the button
                                                                        below.</p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;">
                                                                        user name: {{$email}}</p>
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="center"
                                                                    ...
                                                                    <span class="es-button-border"
                                                                        style="border-style:solid;border-color:#FFA73B;background:#008000;border-width:0px;display:inline-block;border-radius:0px;width:auto;"><a
                                                                            href="http://soccertipstar.test/home"
                                                                            class="es-button" target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-size:20px;color:#FFFFFF;border-style:solid;border-color:#008000;border-width:15px 30px;display:inline-block;background:#008000;border-radius:0px;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;">
